...
| 5   | [XRD Tool](https://github.com/EmilJaffal/XRD-Tool-)              | Python tool for XRD analysis workflows. Manuscript pending.                                  | Inorganic Chemistry (accepted)                                                |
| 6   | [XRD Refinement Plotter](https://xrd-refinement-plotter-e9be4e2d20e5.herokuapp.com)              | XRD app refinement plotter. Source code: [refinement-plot-gui](https://github.com/EmilJaffal/refinement-plot-gui).                                  | [Inorganic Chemistry](https://pubs.acs.org/doi/full/10.1021/acs.inorgchem.5c05813)                                                |
